 ...
 /* Stream<FirstScreenStates> _mapCompanyDetailsCallEventToState(
  ...
  Stream<FirstScreenStates> _mapCustomerRegistrationEventToState(
    ...
    try {
      ...
      await userRepository.CustomerRegistrationAPI(event.pkID,event.customerRegistrationRequest);
      yield CustomerRegistrationResponseState(companyDetailsResponse);
