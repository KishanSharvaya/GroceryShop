...
class _PlacedOrderListScreenState extends BaseState<PlacedOrderListScreen>
  ...
  void initState() {
    ...
    _categoryScreenBloc..add(PlacedOrderDetailsRequestCallEvent(ProductCartDetailsRequest(CustomerID:CustomerID.toString(),CompanyId: CompanyID)));
  ...
  void _onBestSellingListResponse(PlacedOrderResponseState state, BuildContext context) {
  ...
  String ProductImage;*/
      ...
      groceryItem.ProductAlias = state.cartDeleteResponse.details[i].productName;
      ...
      groceryItem.DiscountPer = state.cartDeleteResponse.details[i].discountPercent;
      ...
      groceryItem.ProductImage = state.cartDeleteResponse.details[i].productImage==""?"https://img.icons8.com/bubbles/344/no-image.png":"http://122.169.111.101:206/"+state.cartDeleteResponse.details[i].productImage;
