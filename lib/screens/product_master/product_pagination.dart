...
class _ProductPaginationState extends BaseState<ProductPagination> with BasicScreen,WidgetsBindingObserver{
  ...
  void initState() {
    ...
    productGroupBloc..add(ProductMasterPaginationCallEvent( 1,
        ProductPaginationRequest(CompanyId: CompanyID)));
  }
  searchlistner(){
    productGroupBloc..add(ProductMasterPaginationCallEvent( 1,
        ProductPaginationRequest(CompanyId: CompanyID,SearchKey: searchbar.text)));
  }
  @override
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ProductGroupBloc, ProductStates>(
        ...
        buildWhen: (oldState, currentState) {
          if (currentState is ProductMasterPaginationResponseState||currentState is ProductMasterPaginationSearchResponseState
          ) {
            return true;
          }
          return false;
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is ProductMasterPaginationSearchResponseState||currentState is ProductMasterDeleteResponseState
          ) {
            return true;
          }
          return false;
        ...
        children: [
          Container(
            ...
            child: ExpansionTileCard(
              ...
              leading:
                  Response.details[index].productGroupImage!=null? Image
                      .network(
                                        ...
                                        Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                    Response.details[index].unitPrice.toString() == ""
                                                        ? "N/A"
                                                        :  Response.details[index].unitPrice.toString() ,
                                                    style: TextStyle(
                                                        color: colorDarkBlue,
  ...
  void _onTapOfDelete(productID) {
    ...
    onTapOfPositiveButton: (){
      Navigator.pop(context);
      productGroupBloc.add(ProductMasterDeleteCallEvent(productID,ProductPaginationDeleteRequest(CompanyId: CompanyID)));
  ...
  void _onTapOfEditproduct(ProductPaginationDetails details) {
      navigateTo(context, ManageProduct.routeName,clearSingleStack: true,
