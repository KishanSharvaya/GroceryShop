...
class _ProductGroupPaginationState extends BaseState<ProductGroupPagination> with BasicScreen,WidgetsBindingObserver{
  ...
  void initState() {
    ...
    productGroupBloc..add(ProductGroupCallEvent(
        ProductGroupListRequest(CompanyId: CompanyID,LoginUserID:LoginUserID )));
    searchbar.addListener(onsearchsuccess);
  }
void onsearchsuccess(){
  productGroupBloc.add(ProductGroupSearchCallEvent(
      ProductGroupListRequest(CompanyId: CompanyID,LoginUserID: LoginUserID,SearchKey: searchbar.text.toString())));
}
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ProductGroupBloc, ProductStates>(
        ...
        buildWhen: (oldState, currentState) {
          if (currentState is ProductGroupResponseState||currentState is ProductGroupSearchResponseState
          ) {
            return true;
          }
          return false;
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is ProductGroupSearchResponseState||currentState is ProductGroupDeleteResponseState
          ) {
            return true;
          }
          return false;
        ...
        children: [
          Container(
            ...
            child: ExpansionTileCard(
              ...
              leading: Response.details[index].productGroupImage!=null? Image
                  .network(
                'http://122.169.111.101:206/${Response.details[index].productGroupImage}',
  ...
  void _onTapOfDelete(int pkID) {
    showCommonDialogWithTwoOptions(context, "Do You Want To Delete This Product Group?",
        onTapOfPositiveButton: (){
      Navigator.pop(context);
          productGroupBloc.add(ProductGroupDeleteCallEvent(pkID,ProductGroupDeleteRequest(CompanyId: 4094)));
        }
    );
  }
